...
abstract class UnifiedMnemonic {
  ...
  Future<U8Array78> deriveLdkWalletXprivMethodMnemonic({required Mnemonic that, required Network network, int? hardenedChildIndex, dynamic hint});

  FlutterRustBridgeTaskConstMeta get kDeriveLdkWalletXprivMethodMnemonicConstMeta;

  Future<U8Array32> deriveLdkSeedMethodMnemonic({required Mnemonic that, required Network network, int? hardenedChildIndex, dynamic hint});

  FlutterRustBridgeTaskConstMeta get kDeriveLdkSeedMethodMnemonicConstMeta;
}
...
class Mnemonic {
  ...
  Future<U8Array78> deriveLdkWalletXpriv({required Network network, int? hardenedChildIndex, dynamic hint}) => bridge.deriveLdkWalletXprivMethodMnemonic(
        that: this,
        network: network,
        hardenedChildIndex: hardenedChildIndex,
      );

  Future<U8Array32> deriveLdkSeed({required Network network, int? hardenedChildIndex, dynamic hint}) => bridge.deriveLdkSeedMethodMnemonic(
        that: this,
        network: network,
        hardenedChildIndex: hardenedChildIndex,
      );
...
class U8Array78 extends NonGrowableListView<int> {
  static const arraySize = 78;
  U8Array78(Uint8List inner)
      : assert(inner.length == arraySize),
        super(inner);
  U8Array78.unchecked(Uint8List inner) : super(inner);
  U8Array78.init() : super(Uint8List(arraySize));
}
...
class UnifiedMnemonicImpl implements UnifiedMnemonic {
  ...
  Future<U8Array78> deriveLdkWalletXprivMethodMnemonic({required Mnemonic that, required Network network, int? hardenedChildIndex, dynamic hint}) {
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_derive_ldk_wallet_xpriv__method__Mnemonic(port_, arg0, arg1, arg2),
      parseSuccessData: _wire2api_u8_array_78,
      constMeta: kDeriveLdkWalletXprivMethodMnemonicConstMeta,
      argValues: [
        that,
        network,
        hardenedChildIndex
  ...
  FlutterRustBridgeTaskConstMeta get kDeriveLdkWalletXprivMethodMnemonicConstMeta => const FlutterRustBridgeTaskConstMeta(
        debugName: "derive_ldk_wallet_xpriv__method__Mnemonic",
        argNames: [
          "that",
          "network",
          "hardenedChildIndex"
  ...
  Future<U8Array32> deriveLdkSeedMethodMnemonic({required Mnemonic that, required Network network, int? hardenedChildIndex, dynamic hint}) {
    ...
    var arg2 = _platform.api2wire_opt_box_autoadd_u32(hardenedChildIndex);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_derive_ldk_seed__method__Mnemonic(port_, arg0, arg1, arg2),
      parseSuccessData: _wire2api_u8_array_32,
      constMeta: kDeriveLdkSeedMethodMnemonicConstMeta,
      argValues: [
        that,
        network,
        hardenedChildIndex
  ...
  FlutterRustBridgeTaskConstMeta get kDeriveLdkSeedMethodMnemonicConstMeta => const FlutterRustBridgeTaskConstMeta(
        debugName: "derive_ldk_seed__method__Mnemonic",
        argNames: [
          "that",
          "network",
          "hardenedChildIndex"
...
// Section: wire2api
  ...
  U8Array78 _wire2api_u8_array_78(dynamic raw) {
    return U8Array78(_wire2api_uint_8_list(raw));
  }
