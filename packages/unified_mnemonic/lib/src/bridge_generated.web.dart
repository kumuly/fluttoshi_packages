...
class UnifiedMnemonicWasmModule implements WasmModule {
  ...
  external dynamic /* void */ wire_derive_ldk_wallet_xpriv__method__Mnemonic(NativePortType port_, List<dynamic> that, int network, int? hardened_child_index);

  external dynamic /* void */ wire_derive_ldk_seed__method__Mnemonic(NativePortType port_, List<dynamic> that, int network, int? hardened_child_index);
}
...
class UnifiedMnemonicWire extends FlutterRustBridgeWasmWireBase<UnifiedMnemonicWasmModule> {
  ...
  void wire_derive_ldk_wallet_xpriv__method__Mnemonic(NativePortType port_, List<dynamic> that, int network, int? hardened_child_index) => wasmModule.wire_derive_ldk_wallet_xpriv__method__Mnemonic(port_, that, network, hardened_child_index);

  void wire_derive_ldk_seed__method__Mnemonic(NativePortType port_, List<dynamic> that, int network, int? hardened_child_index) => wasmModule.wire_derive_ldk_seed__method__Mnemonic(port_, that, network, hardened_child_index);
}
